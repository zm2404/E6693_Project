...
class Optimizer:
    ...
    async def black_box_function(self, param, scheduler=None):
        '''
        ...
        if scheduler is None:
            ...
            result = await trial.run_remote(scheduler)
        self.done_trials_num += 1
        return result


    async def optimization(self, initial_points:list=None, scheduler=None):
        ...
        trials = [asyncio.create_task(self.black_box_function(param, scheduler)) for param in initial_points]
